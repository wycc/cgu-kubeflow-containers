...
# Install htop and nvtop for GPU monitoring
RUN apt-get update && apt-get install -y htop nvtop
...
# Install the required language servers (removed reference to R and Julia)
...
ENV GIT_EXAMPLE_NOTEBOOKS=https://github.com/Project-MONAI/tutorials